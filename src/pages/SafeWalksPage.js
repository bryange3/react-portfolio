        ...
        <div>
            ...
            <Content width={width}>
                <body>
                    ...
                    <p className="paragraph">
                        Check out our <a href="https://www.figma.com/file/UZqoBsXPYKCFZ35WACCd4z/University-SafeWalks?node-id=0%3A1" target="_blank" rel="noreferrer" className="default">Figma document</a>. More details coming soon!
                    </p>
