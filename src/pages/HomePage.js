                ...
                <Container fluid={true}>
                    <Row className="justify-content-center py-5">
                        <Col md={width} sm={12}>
                            ...
                            <h3 className="font-weight-normal mt-4 small-description">Currently at <a className="my-blue link-underline" href="https://illinois.edu" target="_blank" rel="noreferrer">UIUC</a> studying <a className="my-blue link-underline" href="https://cs.illinois.edu/academics/undergraduate/degree-program-options/bs-statistics-computer-science" target="_blank" rel="noreferrer">CS + Statistics</a> and designing for <a className="my-blue link-underline" href="https://www.designinnovationillinois.com/" target="_blank" rel="noreferrer">Design Innovation</a>.</h3>
                        </Col>
                    </Row>
                </Container>
            </Jumbotron>
