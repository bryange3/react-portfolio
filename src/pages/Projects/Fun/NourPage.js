        ...
        <div>
            ...
            <Content width={width}>
                <body>
                    ...
                    <p className="paragraph">
                        Check out our <a href="https://www.figma.com/file/o2siBMfCFww1ksk5Xz7ZE5/HackDuke-Ideate-2021-Nour?node-id=0%3A1" target="_blank" rel="noreferrer" className="link-underline">Figma document</a>.
                    </p>

                    <iframe title="Nour Wireframe" className="full-width" style={{ border: "1px solid rgba(0, 0, 0, 0.1)" }} width="800" height="450"  src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Ffile%2Fo2siBMfCFww1ksk5Xz7ZE5%2FHackDuke-Ideate-2021-Nour%3Fnode-id%3D0%253A1" allowfullscreen></iframe>
                </body>
            </Content>
        </div>
    );
